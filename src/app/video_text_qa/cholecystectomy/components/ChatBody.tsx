...
import { appendChatMessage } from '@/app/video_text_qa/cholecystectomy/functions/appendChatMessage';
import { simulateResponse } from '@/app/video_text_qa/cholecystectomy/functions/simulateResponse';
import { processVideo } from '@/app/video_text_qa/cholecystectomy/functions/processVideo';
import { predictVideoText } from '@/app/video_text_qa/cholecystectomy/functions/predictVideoText';
...
const ChatBody: React.FC<PageProps> = (props:PageProps) => {
  ...
  const handleDownload = () => {
    ...
    link.href = '/3.pdf'; 
    link.download = 'Cholecsystectomy .pdf';
    link.click();
