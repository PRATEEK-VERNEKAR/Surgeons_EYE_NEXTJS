...
const App = () => {
  ...
  return (
    <div className="flex h-screen">
      <div className="w-[70%] h-full border-r-2 border-gray-300 flex flex-col p-4">
      ...
      <div className="w-[30%] h-full border-l-2 border-gray-300 p-4 overflow-y-auto" ref={containerRef}>
